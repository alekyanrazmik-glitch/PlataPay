...
export const SERVICES = [
  ...
  // Игры
  { slug: 'steam', name: 'Steam', cat: 'Игры', logo: 'Steam.PNG', domain: 'store.steampowered.com', price: 800, tiers: ['Пополнение кошелька', 'Покупка игры', 'Подарок другу'], hint: 'крупнейшая площадка цифровой дистрибуции игр от Valve — пополняем кошелёк нужного региона (Казахстан, Турция, Аргентина), покупаем игры и подарки' },
